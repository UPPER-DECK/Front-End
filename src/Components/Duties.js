...
import TitleMainDuStyles from "../Background/Duties/TitleMainStyles";
...
export default function Duties() {
	...
	return (
		<Box sx={{ flexGrow: 1, mt: 3 }} id="what">
			<CssBaseline />
			<Typography variant="h4" color="white.main" sx={TitleMainDuStyles}>
				"D{" "}
				<Typography variant="h4" color="brown.main" sx={TitleMainDuStyles}>
					uties"?
				</Typography>
			</Typography>
			<Grid container direction="column" spacing={0.5} sx={DashboardGridStyle}>
				<Grid item xs={12}>
					<Item>
