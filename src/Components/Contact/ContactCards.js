									...
									<CardContent>
										<Grid container spacing={2} sx={{}}>
											<Grid item xs={12} sm={12}>
												<Grid container>
													<Typography gutterBottom variant="h6" component="div" justify="space-evenly" sx={{ fontFamily: "monospace" }}>
														{row.name}
													</Typography>
												</Grid>
												<Divider light />
											...
											<Grid item xs={12} sm={12}>
												<Grid container>
													<Item>
														<Button href={`${row.fb}`}>
															<FacebookIcon sx={{ fontSize: 25, color: "grey.main" }} />
														</Button>
													</Item>
													<Item>
														<Button href={`${row.insta}`}>
															<InstagramIcon sx={{ fontSize: 25, color: "grey.main" }} />
														</Button>
													</Item>
													<Item>
														<Button href={`${row.LinkedIn}`}>
															<LinkedInIcon sx={{ fontSize: 25, color: "grey.main" }} />
														</Button>
													</Item>
												</Grid>
												<Divider light />
